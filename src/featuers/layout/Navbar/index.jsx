            ...
            <div className="flex h-16 justify-between">
              <div className="flex">
                ...
                <div className="flex flex-shrink-0 justify-between items-center !text-indigo-500">
                  ...
                  <div className=" font-semibold">Leap Start</div>
                </div>
          ...
          <Disclosure.Panel className="md:hidden">
            ...
            <div className="border-t border-gray-200 pb-3 pt-4">
              <div className="flex items-center px-4 sm:px-6">
                ...
                <button
                  type="button"
                  className="ml-auto flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none "
                >
                  <span className="sr-only">View notifications</span>
                  <BellIcon className="h-6 w-6" aria-hidden="true" />
                </button>
