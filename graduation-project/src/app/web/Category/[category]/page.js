...
const ArticleCardContent = {
  ...
  technology: {
    ...
    text:
      "Google is reportedly testing a new AI technology codenamed “Genesis” that has the capability to generate news articles. The tech giant has showcased the tool to The New York Times, The Washington Post, and News Corp, the owner of The Wall Street Journal. Observers have witnessed Genesis swiftly generating text based on the fed data, including current events and other forms of information. The purpose of this technology, according to Google, is to assist journalists in automating tasks and freeing up their time for other responsibilities.",
    link:
      "https://fagenwasanni.com/news/google-testing-new-ai-technology-to-generate-news-articles/64912/"
  }
};
